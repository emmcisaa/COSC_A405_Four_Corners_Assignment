...
def run_tiny_corners_search(search_algorithm):
    # Initialize the problem instance from tinyCorners.txt
    filename = 'tinyCorners.txt'
    problem = Problem('tinyCorners.txt')
    ...
    print(f"{search_algorithm} plan for tinyCorners.txt:", plan)
...
# Example usage for tinyCorners.txt with A*
run_tiny_corners_search('A*')
